...
class JadwalPelajaranPolicy
{
    ...
    {
        return $user->can('view_any_jadwal_pelajaran');
    }
    ...
    {
        return $user->can('view_jadwal_pelajaran');
    }
    ...
    {
        return $user->can('create_jadwal_pelajaran');
    }
    ...
    {
        return $user->can('update_jadwal_pelajaran');
    }
    ...
    {
        return $user->can('delete_jadwal_pelajaran');
    }
    ...
    {
        return $user->can('restore_jadwal_pelajaran');
    }
    ...
    {
        return $user->can('force_delete_jadwal_pelajaran');
    }
}