...
class FeeCategoryPolicy
{
    ...
    {
        return $user->can('view_any_fee_category');
    }
    ...
    {
        return $user->can('view_fee_category');
    }
    ...
    {
        return $user->can('create_fee_category');
    }
    ...
    {
        return $user->can('update_fee_category');
    }
    ...
    {
        return $user->can('delete_fee_category');
    }
    ...
    {
        return $user->can('restore_fee_category');
    }
    ...
    {
        return $user->can('force_delete_fee_category');
    }
}
