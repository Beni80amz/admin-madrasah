...
<body
    ...
    <button x-data="{ show: false }" @scroll.window="show = (window.pageYOffset > 300)"
        ...
        class="!fixed !z-50 flex h-12 w-12 items-center justify-center rounded-full bg-teal-600 text-white shadow-lg hover:bg-teal-700 hover:scale-110 hover:shadow-xl transition-all focus:outline-none"
        style="bottom: 2rem !important; right: 2rem !important; left: auto !important; position: fixed !important;"
