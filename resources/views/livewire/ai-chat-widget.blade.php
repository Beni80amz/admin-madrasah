<div>
    ...
    <button wire:click="toggleChat"
        class="!fixed !z-[999999] flex h-12 w-12 items-center justify-center rounded-full bg-primary text-white shadow-2xl hover:bg-emerald-600 hover:scale-110 transition-all focus:outline-none ring-4 ring-white dark:ring-slate-800"
        style="bottom: 2rem !important; right: 2rem !important; left: auto !important;" aria-label="Tanya AI">
        @if($isOpen)
    ...
    <div x-data="{ isOpen: @entangle('isOpen') }" x-show="isOpen"
        ...
        class="!fixed !z-[999999] bg-white dark:bg-slate-900 shadow-2xl rounded-2xl flex flex-col overflow-hidden border border-gray-100 dark:border-slate-800"
        style="display: none; bottom: 6rem !important; right: 2rem !important; left: auto !important; width: 90vw; max-width: 400px; height: 70vh; max-height: 600px;">
        {{-- Header --}}
